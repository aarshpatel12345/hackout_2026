      ...
      >
        ...
        <div className="flex flex-col items-center mb-6">
          <div className="flex flex-col items-center justify-center mb-4">
            <div className="bg-emerald-600 rounded-xl p-3 shadow-sm mb-3">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative flex items-center">
              ...
              <input
                ...
                className={`w-full bg-gray-50 border border-gray-200 text-gray-900 placeholder-gray-400 rounded-xl pl-10 pr-3 py-2.5 text-sm focus:bg-white focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all outline-none ${
                  fieldErrors.name ? "border-red-400 focus:ring-red-500 focus:border-red-500" : ""
                }`}
              />
            </div>
            {fieldErrors.name && (
              <div className="text-red-500 text-xs font-medium mt-1">{fieldErrors.name}</div>
            )}
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative flex items-center">
              ...
              <input
                ...
                className={`w-full bg-gray-50 border border-gray-200 text-gray-900 placeholder-gray-400 rounded-xl pl-10 pr-10 py-2.5 text-sm focus:bg-white focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all outline-none ${
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative flex items-center">
              ...
              <input
                ...
                className={`w-full bg-gray-50 border border-gray-200 text-gray-900 placeholder-gray-400 rounded-xl pl-10 pr-10 py-2.5 text-sm focus:bg-white focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all outline-none ${
                  fieldErrors.confirmPassword ? "border-red-400 focus:ring-red-500 focus:border-red-500" : ""
                }`}
              />
              <button
                type="button"
